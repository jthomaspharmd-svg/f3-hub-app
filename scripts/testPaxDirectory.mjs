...
const main = async () => {
  ...
  console.log("Loaded AOs:", Object.keys(paxByAo).sort().join(", "));
  console.log("Sample Compass PAX:", (paxByAo.compass || []).slice(0, 10));
  console.log("Sample JP PAX:", (paxByAo.jurassicpark || []).slice(0, 10));
  console.log("Band map example (Aquaman):", bandNameByF3Name["Aquaman"]);
};
